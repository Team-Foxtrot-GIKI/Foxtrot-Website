...
function CouncilCard({
  ...
  return (
    <li className="group bg-panel">
      <article className="flex h-full flex-col border border-line transition-[border-color,transform] duration-200 group-hover:-translate-y-1 group-hover:border-amber">
    ...
    <div className="shell py-10">
      <Titleblock
        ...
        fields={[
          ...
          { key: "Positions", value: String(crew.length + 1) },
      ...
      <section id="council" className="mt-14 scroll-mt-24">
        ...
        <div className="mx-auto mt-12 max-w-5xl">
          <div className="mb-5 flex flex-wrap items-baseline justify-between gap-3 border-b border-line pb-3">
            ...
            <p className="label-micro">Subsystem leads</p>
          </div>
